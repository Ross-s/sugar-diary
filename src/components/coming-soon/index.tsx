      ...
      <div className="max-w-2xl w-full text-center">
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
            {allHeaders.get("X-Coming-Soon-Confirm") === "true" && (
              <>
                {/* Success Icon */}
                <div className="mb-8">
                ...
                <div className="mb-10">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    Thank you for confirming your email address. You&apos;re now on our priority
                    list and will be among the first to know when Sugar Diary launches with its
                    comprehensive diabetes management features.
                  </p>
            ...
            {allHeaders.get("X-Coming-Soon-Confirm") !== "true" && (
              <>
                ...
                <div className="mb-10">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                    We&apos;re building the next generation diabetes management tool with
                    intelligent insulin bolus calculations, seamless Nightscout integration, and
                    personalized insights to help you manage your blood glucose levels with
                    confidence.
                  </p>
                </div>
